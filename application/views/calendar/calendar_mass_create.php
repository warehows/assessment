            ...
            <div class="two wizard">
            	...
            	<form action="<?php echo site_url('calendar/save');?>" method="POST">
		                ...
		                <div class="col-sm-10">
		                	<select class="form-control" id="lesson" name="lesson">
		                        ...
		                        <?php foreach ($lesson as $key => $value) {?>
		                        	<option value="<?php echo $value['content_id']; ?>" <?php if ( $lesson_id === $value['content_id'] ) : echo "selected"; endif;?> ><?php echo $value['content_name']; ?></option>
		                        <?php } ?>
		                    </select>
		                </div>
		            </div>
		            ...
		            <div class="form-group row">
		                ...
		                <?php foreach ($grades as $value) {?>
		                	<label class="checkbox-inline">
						      <input type="checkbox" value="<?php echo $value; ?>" checked>Grade <?php echo $value; ?>
						    </label>
						<?php } ?>    	
		                </div>
		            </div>
		                ...
		                <div class="col-sm-10">
		                	<select class="form-control" id="subject" name="subject">
		                        ...
		                        <?php foreach ($subject as $key => $value) {?>
		                        	<option value="<?php echo $value['cid']; ?>" selected><?php echo $value['category_name']; ?></option>
		                        <?php } ?>
		                    </select>
		                </div>
		            </div>
		                ...
		                <label class="control-label col-sm-2" for="section">Section:</label>
		                	<div class="col-sm-10">
								<?php foreach ($sections as $section) { ?>
									<label class="checkbox-inline">
										<input type="checkbox" name="section[]" checked onclick="return false;" value="<?php echo $section['gid']; ?>"><?php echo $section['group_name']; ?>
									</label><br>
								<?php } ?>
		                </div>
		            </div>
		            ...
		            <div class="form-group row">
		                ...
		                <div class="col-sm-10">
		                    <input type="text" id="dateFrom" class="form-control" name="dateFrom" value="<?php echo $date_from; ?>">
		                </div>
		            </div>
		            ...
		            <div class="form-group row">
		                ...
		                <div class="col-sm-10">
		                    <input type="text" id="dateTo" class="form-control" name="dateTo" value="<?php echo $date_to; ?>">
		                </div>
		            </div>
