                ...
                <div class="login-panel panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="inputEmail" name="email" value="<?php echo $result['email']; ?>"
                        ...
                        <div class="form-group">
                            <label for="inputPassword"
                                   class="sr-only">Admin Password</label>
                            <input type="password" id="inputAdminPassword" name="admin_password" value="" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="gid" onChange="getexpiry();" id="gid">
                                ...
                                foreach ($group_list as $key => $val) {
                                    ...
                                    <option
                                        value="<?php echo $val['gid']; ?>" <?php if ($result['gid'] == $val['gid']) {
                                        echo 'selected';
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <input type="hidden" name="subscription_expired" id="subscription_expired"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="su">
                                <option value="0" <?php if ($result['su'] < 1) {
                                    echo 'selected';
                                } ?> ><?php echo "Student"; ?></option>
                                <option value="2" <?php if ($result['su'] == 2) {
                                    echo 'selected';
                                } ?> ><?php echo "Teacher"; ?></option>
