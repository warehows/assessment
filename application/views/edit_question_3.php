<div class="wrapper">
    ...
    <div class="row">
        <form method="post" action="<?php echo site_url('qbank/edit_question_3/')."/".$question['qid']."/".$quid; ?>">
                    ...
                    <div class="panel-body">
                        ...
                        foreach ($options as $key => $val) {
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="option[]" value="<?php echo $val['q_option']; ?>"> = <input
                                    type="text" name="option2[]" value="<?php echo $val['q_option_match']; ?>">
                            </div>
                            <?php
                        }
                        ?>
