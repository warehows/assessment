...
<div class="left-container" id="right_container"
    ...
    <div class="header" style="font-weight: bold; font-size: 14px; color: #ffffff; padding: 30px 10px;margin: 0 0px; background-color: #fe0000; background-repeat: repeat-x;">
    ...
    <ul style="height: auto;padding: 0px 9px; margin: 0px 40px; list-style: none;">
        <?php foreach ($lesson_contents as $lesson_contents_key => $lesson_contents_value) { ?>
            ...
            <?php if ($lesson_contents_value['folder_name'] == "Engage") { ?>
                <li style="cursor:pointer" class="content" value="<?php echo $root_link.$folder_location.$lesson_contents_value['content_name']; ?>"><?php echo $lesson_contents_value['content_name']; ?></li>
            <?php } ?>
