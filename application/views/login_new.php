...
<div class="register-photo">
    ...
    <div class="form-container">
        ...
        <form method="post" method="post" action="<?php echo site_url('login/verifylogin'); ?>">
            ...
            <h2 align="center" style="  margin-top:-25px!important;">St. Therese Private School</h2>
            ...
            <div class="illustration" style="margin-top:-20px!important;"><img
                    style="align: center!important; height: 190px!important;" class="navbar-brand image_logo"
                    src="<?php echo base_url('css/new_material/img/steps.png'); ?>" alt="School Logo" align="center">
            </div>
