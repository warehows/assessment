...
<!--                        <span-->
<!--                            class="pull-left">--><?php //echo $this->lang->line('users'); ?><!----><?php //echo $this->lang->line('list'); ?><!--</span>-->
        ...
        <div class="col-md-4">
            <div class="panel panel-warning">
                ...
                <a href="<?php echo site_url('qbank'); ?>">
                    <div
                        class="panel-footer"><?php echo $this->lang->line('question'); ?> <?php echo $this->lang->line('list'); ?></span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
