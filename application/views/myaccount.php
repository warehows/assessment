                ...
                <div class="login-panel panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="inputEmail" name="email" value="<?php echo $result['email']; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="last_name" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="contact_no" class="form-control"
                        ...
                        <div class="form-group" id="passwordFields" style="display:none">
                            ...
                            <input type="password" id="confirmOldPassword" name="oldpassword" class="form-control"
