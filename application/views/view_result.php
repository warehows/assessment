...
<?php echo $this->lang->line('hello'); ?> <?php echo $result['first_name']; ?>
                            ...
                            !</span> <?php echo str_replace('{attempt_no}', ordinal($attempt), $this->lang->line('title_result')); ?>
                    </h3></center>
            </div>
            <div class="col-lg-12">
                <center>
            ...
            <div class="col-lg-12" style="margin-top:20px;">
                ...
                <div class="col-lg-2" style="text-align:center;">
                    ...
                    <p>Passing Rate</p>
                    <!--		<p style="color:#e39500;" >-->
                    <?php //echo substr(((($percentile[1]+1)/$percentile[0])*100),0,5);   ?><!--%</p>-->
...
<!--                </div>-->
    ...
    <div class="row">
        ...
        <div class="col-md-12">
                        ...
                        if ($result['camera_req'] == '1') {
                            ...
                            <tr>
                                <td colspan='2'> <?php if ($result['photo'] != '') { ?> <img
                                        src="<?php echo base_url('photo/' . $result['photo']); ?>"
                                        id="photograph" ><?php } ?></td>
                            </tr>
            ...
            <!--					<table class="table table-bordered">-->
            <!--					 <thead> <tr><th style="background:#337ab7;color:#ffffff;">-->
            ...
            <!--					  <th  style="background:#337ab7;color:#ffffff;">-->
            <?php //echo $this->lang->line('correct');?><!--</th>-->
            <!--					 <th  style="background:#337ab7;color:#ffffff;">-->
            ...
            <!--						<td>-->
            <?php //if(isset($cia_cat[0][$vk])){ echo $cia_cat[0][$vk]; $correct+=$cia_cat[0][$vk]; }else{ echo '0'; } ?><!--</td>-->
            <!--						<td>-->
            <?php //  if(isset($cia_cat[1][$vk])){ echo $cia_cat[1][$vk]; $incorrect+=$cia_cat[1][$vk]; }else{ echo '0';  } ?><!--</td>-->
            <!--						<td>-->
            <?php //  if(isset($cia_cat[2][$vk])){ echo $cia_cat[2][$vk]; $notattempted+=$cia_cat[2][$vk]; }else{ echo '0';  } ?><!--</td>-->
            <!---->
            <!--						</tr>-->
            <!--					 --><?php
            //					  }
            ...
            <div class="login-panel panel panel-default">
                <div class="panel-body">
                    ...
                    foreach ($questions as $qk => $question) {
                        ?>
                        <hr>
                        <div id="q<?php echo $qk; ?>" class=""
                             style="<?php if ($ind_score[$qk] == '1') { ?>background-color:#e3f8da;<?php } else if ($ind_score[$qk] == '2') { ?>background-color:#ffe1cb;<?php } else if ($ind_score[$qk] == '3') { ?>background-color:#fdfbcf;<?php } else { ?>background-color:#ffffff;<?php } ?>">
                                ...
                                if ($question['question_type'] == $this->lang->line('long_answer')) {
                                    ...
                                    <div class="op">
                                        ...
                                        <textarea name="answer[<?php echo $qk; ?>][]"
                                                  id="answer_value<?php echo $qk; ?>" style="width:100%;height:100%;"
                                ...
                                if ($question['question_type'] == $this->lang->line('match_the_column')) {
                                    ...
                                    <div class="op">
                                        <table>
                                            <tr>
                                                <td></td>
                                                <td><?php echo $this->lang->line('your_answer'); ?></td>
                                                <td><?php echo $this->lang->line('correct_answer'); ?></td>
                                            </tr>
                                            <?php
